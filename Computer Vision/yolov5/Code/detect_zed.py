...
def run(
        ...
        data=ROOT / 'runs/train/exp4/hyp.yaml',  # dataset.yaml path
...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default=ROOT / 'runs/train/exp4/hyp.yaml', help='(optional) dataset.yaml path')
